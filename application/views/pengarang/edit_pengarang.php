      ...
      <form method="post" action="<?= base_url('pengarang/update');?>" class="form-horizontal">
        <div class="box-body">
          <div class="form-group">
            <label for="" class="col-sm-2 control-label">ID Pengarang</label>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="nama_pengarang" id="nama" value="<?= $data['nama_pengarang'];?>" required>
            </div>
          </div>
